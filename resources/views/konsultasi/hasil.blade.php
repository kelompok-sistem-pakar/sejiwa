    ...
    <aside class="w-80 bg-white shadow-xl p-10">
        <div class="mb-12">
            <div class="flex justify-center mb-16">
                <img src="{{ asset('images/logo.png') }}" alt="Sejiwa" class="h-20 w-auto">
            </div>
    ...
    <main class="flex-1 p-12">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="flex justify-end">
                <a href="{{ route('home') }}" class="bg-lime-400 hover:bg-lime-500 text-white font-semibold px-8 py-3 rounded-lg transition duration-200 inline-block">
                    Selesai
                </a>
            </div>
        </div>
        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="flex items-center space-x-2 ml-6">
                    <img src="{{ asset('images/logo.png') }}" alt="Sejiwa" class="h-6">
