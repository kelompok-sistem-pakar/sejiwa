        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="space-y-8">
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-4">
                    <a href="{{ route('konsultasi.index') }}" class="inline-flex items-center justify-center px-8 py-4 bg-lime-400 hover:bg-lime-500 text-gray-900 font-semibold rounded-xl transition-colors shadow-lg text-lg">
                        Konsult Sekarang Yuk
                    </a>
                    <a href="{{ route('about') }}" class="inline-flex items-center justify-center px-8 py-4 bg-white hover:bg-gray-50 text-gray-700 font-semibold rounded-xl border-2 border-gray-300 transition-colors text-lg">
                        Explore Gejala
                    </a>
                </div>
                ...
                <div class="pt-8">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="w-20 h-20 bg-lime-300 rounded-2xl flex items-center justify-center overflow-hidden shadow-md">
                            <img src="{{ asset('images/konsul1.png') }}" alt="Expert 1" class="w-full h-full object-cover">
                        </div>
                        <div class="w-20 h-20 bg-lime-200 rounded-2xl flex items-center justify-center overflow-hidden shadow-md">
                            <img src="{{ asset('images/konsul2.png') }}" alt="Expert 2" class="w-full h-full object-cover">
                        </div>
                        <div class="w-20 h-20 bg-gray-200 rounded-2xl flex items-center justify-center overflow-hidden shadow-md">
                            <img src="{{ asset('images/konsul3.png') }}" alt="Expert 3" class="w-full h-full object-cover">
                        </div>
                        <div class="w-20 h-20 bg-gray-200 rounded-2xl flex items-center justify-center overflow-hidden shadow-md">
                            <img src="{{ asset('images/konsul4.png') }}" alt="Expert 4" class="w-full h-full object-cover">
                        </div>
            ...
            <div class="relative">
                ...
                <div class="relative bg-lime-300 rounded-3xl overflow-hidden shadow-2xl">
                    <img src="{{ asset('images/konsul1.png') }}" alt="Psucologist" class="w-full h-auto object-cover">
                    
                    <!-- Floating Psychologist Card -->
                    <div class="absolute bottom-8 right-8 bg-white rounded-2xl shadow-xl p-4 max-w-[200px]">
                        <div class="flex items-center gap-3">
                            <img src="{{ asset('images/konsul2.png') }}" alt="Psychologist" class="w-12 h-12 rounded-full object-cover">
                            <div class="flex-1">
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative">
            ...
            <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
                <img src="{{ asset('images/gariskonsul.png') }}" alt="Connecting Line" class="w-full h-auto opacity-100 max-w-4xl">
            </div>
            
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 relative z-10">
                <!-- Card 01 -->
                <div class="relative">
                    <img src="{{ asset('images/konsul1.png') }}" alt="Mengisi Data Diri Pasien" class="w-full h-auto transform transition-all duration-300 hover:scale-105 hover:rotate-1 rotate-[-2deg]">
                </div>
                
                <!-- Card 02 -->
                <div class="relative md:mt-16">
                    <img src="{{ asset('images/konsul2.png') }}" alt="Menjawab Pertanyaan Gejala" class="w-full h-auto transform transition-all duration-300 hover:scale-105 hover:rotate-[-1deg] rotate-[2deg]">
                </div>
                
                <!-- Card 03 -->
                <div class="relative">
                    <img src="{{ asset('images/konsul3.png') }}" alt="Konfirmasi & Proses" class="w-full h-auto transform transition-all duration-300 hover:scale-105 hover:rotate-1 rotate-[-1deg]">
                </div>
                
                <!-- Card 04 -->
                <div class="relative md:mt-16">
                    <img src="{{ asset('images/konsul4.png') }}" alt="Hasil" class="w-full h-auto transform transition-all duration-300 hover:scale-105 hover:rotate-[-1deg] rotate-[1deg]">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="flex justify-center lg:justify-start">
                    <div class="relative">
                        <div class="border-4 border-white-400 rounded-2xl overflow-hidden bg-lime-100 p-6 max-w-md">
                            <img src="{{ asset('images/konsul1.png') }}" alt="Expert" class="w-full h-auto mb-6">
