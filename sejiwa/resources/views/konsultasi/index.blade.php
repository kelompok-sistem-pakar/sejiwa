...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex">
    ...
    <aside class="w-80 bg-white shadow-xl p-10 flex flex-col">
        ...
        <div class="mb-12">
            <div class="flex justify-center mb-8">
                <img src="{{ asset('images/logo.png') }}" alt="Sejiwa Logo" class="h-20 w-auto">
            </div>
        </div>
    ...
    <main class="flex-1 p-12">
        <div class="max-w-4xl mx-auto">
            ...
            <form action="{{ route('konsultasi.store') }}" method="POST" class="bg-white rounded-2xl shadow-lg p-8 space-y-6">
                @csrf
