...
<body class="bg-gradient-to-br from-gray-50 to-gray-100">
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-white shadow-xl p-8">
            ...
            <nav class="space-y-2">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="block py-3 px-4 text-gray-700 hover:bg-gray-100 rounded-xl font-medium transition-all duration-200">Konsultasi</a>
                ...
                <a href="<?php echo e(route('admin.penyakit')); ?>" class="block py-3 px-4 bg-lime-400 text-gray-900 rounded-xl font-semibold shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200">Penyakit</a>
...
<?php /**PATH C:\Users\difar\sejiwa\resources\views/admin/penyakit.blade.php ENDPATH**/ ?>