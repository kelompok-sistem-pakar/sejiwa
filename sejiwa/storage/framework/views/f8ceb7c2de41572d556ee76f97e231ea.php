    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-white shadow-xl p-8">
            ...
            <nav class="space-y-2">
                ...
                <a href="<?php echo e(route('admin.mahasiswa')); ?>" class="block py-3 px-4 bg-lime-400 text-gray-900 rounded-xl font-semibold shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200">User</a>
...
<?php /**PATH C:\Users\difar\sejiwa\resources\views/admin/mahasiswa.blade.php ENDPATH**/ ?>